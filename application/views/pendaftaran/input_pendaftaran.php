<h2 class="page-title mb-3"> Pendaftaran </h2>
<div><?php echo $this->session->flashdata('msg');?></div>
<form id="formpendaftaran" method="POST" action="<?php echo base_url(); ?>pendaftaran/insertpendaftaran">
    <div class="row">
        <div class="col-md-5">
            <div class="card">
                <div class="card-body">
                    <div class="input-icon mb-3">
                        ...
                        <input type="text" name="id_pendaftaran" readonly value="<?php echo $id_pendaftaran; ?>" id="id_pendaftaran" class="form-control" placeholder="ID Pendaftaran">
                    </div>
                    <div class="input-icon mb-3">
                        
                        <input type="text" hidden id="tgl_pendaftaran" value="<?php echo date("Y-m-d"); ?>" readonly  name="tgl_pendaftaran" class="form-control" placeholder="Tanggal Pendaftaran">
                    </div>
                    <div class="input-icon mb-3">
                        <span class="input-icon-addon">
                    ...
                    <div class="input-icon mb-3">
                        ...
                        <input type="hidden" name="harga-diskon" id="harga-diskon">
                        <input type="hidden" name="total-value" id="total-value">
                        <input type="hidden" name="value-dp" id="value-dp">
                    ...
                    <div class="input-icon mb-3">
                        ...
                        <input type="hidden" name="b-price" id="b-price">
                        <input type="hidden" name="b-diskon" id="b-diskon">
                    ...
                    <label class="form-label">Tanggal Jatuh Tempo</label>  
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" name="jatuhtempo" readonly id="jatuhtempo" class="form-control" placeholder="Jatuh Tempo">
                        </div>
                    </div>
                    <div class="input-icon mb-3">
                        <span class="input-icon-addon">
